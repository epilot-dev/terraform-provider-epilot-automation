...
type EntityOperationTriggerSchemasType struct {
	...
	EqualsIgnoreCaseCondition *EqualsIgnoreCaseCondition `queryParam:"inline" union:"member"`
	AnythingButCondition      *AnythingButCondition      `queryParam:"inline" union:"member"`
	ExistsCondition           *ExistsCondition           `queryParam:"inline" union:"member"`
	PrefixCondition           *PrefixCondition           `queryParam:"inline" union:"member"`
	SuffixCondition           *SuffixCondition           `queryParam:"inline" union:"member"`
	WildcardCondition         *WildcardCondition         `queryParam:"inline" union:"member"`
