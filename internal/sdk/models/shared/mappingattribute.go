...
type MappingAttribute struct {
	SetValueMapper    *SetValueMapper    `queryParam:"inline" union:"member"`
	CopyValueMapper   *CopyValueMapper   `queryParam:"inline" union:"member"`
	AppendValueMapper *AppendValueMapper `queryParam:"inline" union:"member"`
