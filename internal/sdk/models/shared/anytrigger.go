...
const (
	...
	AnyTriggerTypeNewEmailThreadTrigger  AnyTriggerType = "NewEmailThreadTrigger"
	AnyTriggerTypeFlowsTrigger           AnyTriggerType = "FlowsTrigger"
)

type AnyTrigger struct {
	FrontendSubmitTrigger  *FrontendSubmitTrigger  `queryParam:"inline" union:"member"`
	JourneySubmitTrigger   *JourneySubmitTrigger   `queryParam:"inline" union:"member"`
	APISubmissionTrigger   *APISubmissionTrigger   `queryParam:"inline" union:"member"`
	EntityOperationTrigger *EntityOperationTrigger `queryParam:"inline" union:"member"`
	Any                    any                     `queryParam:"inline" union:"member"`
	EntityManualTrigger    *EntityManualTrigger    `queryParam:"inline" union:"member"`
	ReceivedEmailTrigger   *ReceivedEmailTrigger   `queryParam:"inline" union:"member"`
	NewEmailThreadTrigger  *NewEmailThreadTrigger  `queryParam:"inline" union:"member"`
	FlowsTrigger           *FlowsTrigger           `queryParam:"inline" union:"member"`
...
func CreateAnyTriggerNewEmailThreadTrigger(newEmailThreadTrigger NewEmailThreadTrigger) AnyTrigger {
	typ := AnyTriggerTypeNewEmailThreadTrigger
...
func (u *AnyTrigger) UnmarshalJSON(data []byte) error {
	...
	var newEmailThreadTrigger NewEmailThreadTrigger = NewEmailThreadTrigger{}
	if err := utils.UnmarshalJSON(data, &newEmailThreadTrigger, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  AnyTriggerTypeNewEmailThreadTrigger,
			Value: &newEmailThreadTrigger,
		})
	}
	...
	case AnyTriggerTypeReceivedEmailTrigger:
		...
		return nil
	case AnyTriggerTypeNewEmailThreadTrigger:
		u.NewEmailThreadTrigger = best.Value.(*NewEmailThreadTrigger)
		return nil
...
func (u AnyTrigger) MarshalJSON() ([]byte, error) {
	...
	if u.NewEmailThreadTrigger != nil {
		return utils.MarshalJSON(u.NewEmailThreadTrigger, "", true)
	}
