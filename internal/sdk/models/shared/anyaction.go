...
const (
	...
	AnyActionTypeTriggerEventAction        AnyActionType = "TriggerEventAction"
...
type AnyAction struct {
	MapEntityAction           *MapEntityAction           `queryParam:"inline" union:"member"`
	TriggerWorkflowAction     *TriggerWorkflowAction     `queryParam:"inline" union:"member"`
	TriggerShareEntityAction  *TriggerShareEntityAction  `queryParam:"inline" union:"member"`
	TriggerWebhookAction      *TriggerWebhookAction      `queryParam:"inline" union:"member"`
	InformERPAction           *InformERPAction           `queryParam:"inline" union:"member"`
	TriggerEventAction        *TriggerEventAction        `queryParam:"inline" union:"member"`
	CreateDocumentAction      *CreateDocumentAction      `queryParam:"inline" union:"member"`
	SendEmailAction           *SendEmailAction           `queryParam:"inline" union:"member"`
	CartCheckoutAction        *CartCheckoutAction        `queryParam:"inline" union:"member"`
...
func CreateAnyActionTriggerEventAction(triggerEventAction TriggerEventAction) AnyAction {
	typ := AnyActionTypeTriggerEventAction
...
func (u *AnyAction) UnmarshalJSON(data []byte) error {
	...
	var triggerEventAction TriggerEventAction = TriggerEventAction{}
	if err := utils.UnmarshalJSON(data, &triggerEventAction, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  AnyActionTypeTriggerEventAction,
			Value: &triggerEventAction,
		})
	}
	...
	case AnyActionTypeInformERPAction:
		...
		return nil
	case AnyActionTypeTriggerEventAction:
		u.TriggerEventAction = best.Value.(*TriggerEventAction)
		return nil
...
func (u AnyAction) MarshalJSON() ([]byte, error) {
	...
	if u.TriggerEventAction != nil {
		return utils.MarshalJSON(u.TriggerEventAction, "", true)
	}
