...
const (
	...
	TriggerEventTypeTriggerEventMessaging          TriggerEventType = "TriggerEventMessaging"
)

type TriggerEvent struct {
	TriggerEventManual             *TriggerEventManual             `queryParam:"inline" union:"member"`
	TriggerEventEntityActivity     *TriggerEventEntityActivity     `queryParam:"inline" union:"member"`
	TriggerEventEntityOperation    *TriggerEventEntityOperation    `queryParam:"inline" union:"member"`
	TriggerEventFlowAutomationTask *TriggerEventFlowAutomationTask `queryParam:"inline" union:"member"`
	TriggerEventMessaging          *TriggerEventMessaging          `queryParam:"inline" union:"member"`
...
func CreateTriggerEventTriggerEventMessaging(triggerEventMessaging TriggerEventMessaging) TriggerEvent {
	typ := TriggerEventTypeTriggerEventMessaging
...
func (u *TriggerEvent) UnmarshalJSON(data []byte) error {
	...
	var triggerEventMessaging TriggerEventMessaging = TriggerEventMessaging{}
	if err := utils.UnmarshalJSON(data, &triggerEventMessaging, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  TriggerEventTypeTriggerEventMessaging,
			Value: &triggerEventMessaging,
		})
	}
	...
	case TriggerEventTypeTriggerEventFlowAutomationTask:
		...
		return nil
	case TriggerEventTypeTriggerEventMessaging:
		u.TriggerEventMessaging = best.Value.(*TriggerEventMessaging)
		return nil
	}
...
func (u TriggerEvent) MarshalJSON() ([]byte, error) {
	...
	if u.TriggerEventMessaging != nil {
		return utils.MarshalJSON(u.TriggerEventMessaging, "", true)
	}
