				...
				NestedObject: schema.NestedAttributeObject{
					...
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							Computed:    true,
							Optional:    true,
							Description: `Stable identifier referenced by AutomationActionConfig.loop_id. Not Null`,
							Validators: []validator.String{
								speakeasy_stringvalidators.NotNull(),
							},
						},
						...
						"source_path": schema.StringAttribute{
							Computed:    true,
							Optional:    true,
							Description: `Path resolved against the trigger entity to produce the array of iteration items. e.g. submission.steps[0]['Contracts']. Not Null`,
							Validators: []validator.String{
								speakeasy_stringvalidators.NotNull(),
							},
						},
						"source_type": schema.StringAttribute{
							Computed:    true,
							Optional:    true,
							Default:     stringdefault.StaticString(`journey-multi-select`),
						...
						"any": schema.StringAttribute{
							...
							Validators: []validator.String{
								stringvalidator.ConflictsWith(path.Expressions{
									...
									path.MatchRelative().AtParent().AtName("new_email_thread_trigger"),
						...
						"new_email_thread_trigger": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								"configuration": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										"direction": schema.StringAttribute{
											Computed:    true,
											Optional:    true,
											Description: `Whether the trigger should be matched against only inbound, outbound emails or both. Not Null; must be one of ["INBOUND", "OUTBOUND", "BOTH"]`,
											Validators: []validator.String{
												speakeasy_stringvalidators.NotNull(),
												stringvalidator.OneOf(
													"INBOUND",
								...
								"type": schema.StringAttribute{
									Computed:    true,
									Optional:    true,
									Description: `Not Null; must be "new_email_thread"`,
									Validators: []validator.String{
										speakeasy_stringvalidators.NotNull(),
										stringvalidator.OneOf(
											"new_email_thread",
