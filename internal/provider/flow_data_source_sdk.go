...
func (r *FlowDataSourceModel) RefreshFromGetResponse(resp *shared.AutomationFlow) {
	r.Actions = nil
	for _, actionsItem := range resp.Actions {
		var actions1 AnyActionConfig1
		if actionsItem.MapEntityActionConfig != nil {
			actions1.MapEntityActionConfig = &MapEntityActionConfig1{}
			...
			if actions1.MapEntityActionConfig.Config == nil {
				actions1.MapEntityActionConfig.Config = &MapEntityConfig1{}
			}
			if actionsItem.MapEntityActionConfig.Config == nil {
				...
				for _, mappingAttributesItem := range actionsItem.MapEntityActionConfig.Config.MappingAttributes {
					var mappingAttributes1 MapEntityConfigMappingAttributes1
					if mappingAttributesItem.MappingAttributeV2 != nil {
						mappingAttributes1.MappingAttributeV2 = &MappingAttributeV22{}
						if mappingAttributesItem.MappingAttributeV2.Operation.OperationObjectNode != nil {
							mappingAttributes1.MappingAttributeV2.Operation.OperationObjectNode = &OperationObjectNode2{}
		...
		if actionsItem.CartCheckoutActionConfig != nil {
			actions1.CartCheckoutActionConfig = &CartCheckoutActionConfig1{}
			...
			if actions1.CartCheckoutActionConfig.Config == nil {
				actions1.CartCheckoutActionConfig.Config = &CartCheckoutConfig1{}
			}
			if actionsItem.CartCheckoutActionConfig.Config == nil {
				...
				for _, mappingAttributesItem1 := range actionsItem.CartCheckoutActionConfig.Config.MappingAttributes {
					var mappingAttributes3 CartCheckoutConfigMappingAttributes1
					if mappingAttributesItem1.MappingAttributeV2 != nil {
						mappingAttributes3.MappingAttributeV2 = &MappingAttributeV23{}
						if mappingAttributesItem1.MappingAttributeV2.Operation.OperationObjectNode != nil {
							mappingAttributes3.MappingAttributeV2.Operation.OperationObjectNode = &OperationObjectNode3{}
				...
				for _, relationAttributesItem1 := range actionsItem.CartCheckoutActionConfig.Config.RelationAttributes {
					...
					if relationAttributes3.RelatedTo == nil && len(relationAttributesItem1.RelatedTo) > 0 {
						...
						for key1, value4 := range relationAttributesItem1.RelatedTo {
							result1, _ := json.Marshal(value4)
							relationAttributes3.RelatedTo[key1] = types.StringValue(string(result1))
						}
					}
		...
		if actionsItem.AutomationActionConfig != nil {
			...
			if actions1.AutomationActionConfig.Config == nil && len(actionsItem.AutomationActionConfig.Config) > 0 {
				...
				for key2, value5 := range actionsItem.AutomationActionConfig.Config {
					result2, _ := json.Marshal(value5)
					actions1.AutomationActionConfig.Config[key2] = types.StringValue(string(result2))
				}
			}
